...
class DepartmentController extends Controller
{
    ...
    public function store(StoreDepartmentRequest $request)
    {
        try {
            ...
            return redirect()->route('getDepartment')->with('success', 'Thêm phòng ban thành công');
        } catch (\Exception $err) {
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('getDepartment')->with('success', 'Update phòng ban thành công');
        } catch (\Exception $err) {
